            ...
            <div className="space-y-2 lg:space-y-4">
              ...
              <div>
                <div className="flex flex-col items-center">
                  ...
                  <div className="absolute flex items-center justify-center w-8 h-8 transform -translate-x-1/2 -translate-y-4 bg-green-500 rounded-full  left-1/2 lg:translate-y-[4px]">
              ...
              <div>
                <div className="flex flex-col items-center">
                        ...
                        <div className="relative z-20 ">
                          <div className="flex flex-wrap items-center">
                            ...
                            <div className="flex-1 p-4 pr-4 border-l border-gray-300 ">
                              ...
                              <p className="text-gray-700 ">До новых встреч</p>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="absolute flex items-center justify-center w-8 h-8 transform -translate-x-1/2 -translate-y-4 bg-red-500 rounded-full  left-1/2 lg:translate-y-[3px]">
