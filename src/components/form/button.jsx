...
function Button({ label = "label", color }) {
  return (
    <div className="relative inline-flex  group">
      ...
      <button
        href="#"
        className="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white transition-all duration-200 bg-green-900 rounded-xl focus:outline-none "
